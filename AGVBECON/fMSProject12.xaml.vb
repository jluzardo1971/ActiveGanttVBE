...
Partial Public Class fMSProject12
    ...
    Private oServiceContext As MSP2007Context = New MSP2007Context()
...
#Region "Page Loaded"
    ...
    Private Sub fMSProject12_Loaded(sender As Object, e As System.Windows.RoutedEventArgs) Handles Me.Loaded
        invkGetFileList = oServiceContext.GetFileList()
        mp_fLoad = New fLoad()
        AddHandler mp_fLoad.Closed, AddressOf mp_fLoad_Closed

        Me.Title = "The Source Code Store - ActiveGantt Scheduler Control Version " & ActiveGanttVBECtl1.Version & " - Microsoft Project 2007 integration using XML Files and the MSP2007 Integration Library"
        InitializeAG()
...
#Region "Functions"
    ...
    Private Sub InitializeAG()
        ...
        ActiveGanttVBECtl1.Style.BorderColor = Color.FromArgb(255, 122, 151, 193)
        ActiveGanttVBECtl1.Style.BorderWidth = 1

        ActiveGanttVBECtl1.Splitter.Type = E_SPLITTERTYPE.SA_USERDEFINED
        ActiveGanttVBECtl1.Splitter.Width = 4
        ActiveGanttVBECtl1.Splitter.SetColor(1, Color.FromArgb(255, 197, 206, 216))
        ActiveGanttVBECtl1.Splitter.SetColor(2, Colors.White)
        ActiveGanttVBECtl1.Splitter.SetColor(3, Colors.White)
        ActiveGanttVBECtl1.Splitter.SetColor(4, Color.FromArgb(255, 197, 206, 216))
        ...
        ActiveGanttVBECtl1.ScrollBarSeparator.Style.Appearance = E_STYLEAPPEARANCE.SA_FLAT
        ActiveGanttVBECtl1.ScrollBarSeparator.Style.BackgroundMode = GRE_BACKGROUNDMODE.FP_SOLID
        ActiveGanttVBECtl1.ScrollBarSeparator.Style.BackColor = Color.FromArgb(255, 164, 196, 237)
        ...
        ActiveGanttVBECtl1.VerticalScrollBar.ScrollBar.ThumbButton.PressedStyleIndex = "ThumbButtonV"
        ...
        ActiveGanttVBECtl1.HorizontalScrollBar.ScrollBar.ThumbButton.PressedStyleIndex = "ThumbButtonH"
    ...
    Private Function GetAGPredecessorType(ByVal MPPredecessorType As MSP2007.E_TYPE_5) As AGVBE.E_CONSTRAINTTYPE
