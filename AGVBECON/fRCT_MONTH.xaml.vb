...
Partial Public Class fRCT_MONTH
    Inherits Page
    ...
    Private Sub Page_Loaded(sender As System.Object, e As System.Windows.RoutedEventArgs) Handles MyBase.Loaded
        ...
        oView = ActiveGanttVBECtl1.Views.Add(E_INTERVAL.IL_HOUR, 1, E_TIERTYPE.ST_MONTH, E_TIERTYPE.ST_DAYOFWEEK, E_TIERTYPE.ST_DAYOFWEEK, "View1")
        oView.TimeLine.TierArea.MiddleTier.Visible = False
        oView.TimeLine.TickMarkArea.Visible = False
        ActiveGanttVBECtl1.TierFormatScope = E_TIERFORMATSCOPE.TFS_CONTROL
        ActiveGanttVBECtl1.TierFormat.DayOfWeekIntervalFormat = "dd"
        ...
        dtDate = New AGVBE.DateTime(2000, 1, 1, 0, 0, 0)
